...
.. code-block:: bash
    ...
    # Usage
    ./isaaclab.sh -p UMBC/data_collection/flat/phase1.py
...
def main():
    ...
    action_df.to_csv('UMBC/logs/dataset/flat/1_action_df.csv', index=False)
    obs_df.to_csv('UMBC/logs/dataset/flat/1_obs_df.csv', index=False)
