...
.. code-block:: bash
    ...
    # Usage
    ./isaaclab.sh -p UMBC/data_collection/stairway/phase2.py
...
class H1FlatDemo:
    ...
    * ESC: exit current third-person view"""
    ...
    def __init__(self):
        ...
        checkpoint = "UMBC/logs/policy/stairway_expert.pt"
        # create envionrment
...
def main():
    ...
    action_df.to_csv('UMBC/logs/dataset/stairway/2_action_df.csv', index=False)
    obs_df.to_csv('UMBC/logs/dataset/stairway/2_obs_df.csv', index=False)
