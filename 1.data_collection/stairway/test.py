# ./isaaclab.sh -p scripts/ulbc_v1/1.data_collection/stairway/test.py
...
OUT_DIR = "scripts/ulbc_v1/dataset/test/stairway"
...
class H1StairwayDemo:
    def __init__(self):
        ...
        checkpoint = "scripts/ulbc_v1/logs/models/drl_stairway.pt"
        # create envionrment
