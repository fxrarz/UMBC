# python3 scripts/UMBC/2.unified_policy/train_nolabel.py
...
def retrain_and_log(params, terrain_dirs, save_path):
    ...
    model = LocomotionPolicy(num_terrains=num_terrains, embed_dim=0).to(device)
    ...
    for epoch in range(params['epoch']):
        ...
        for inputs, targets in train_loader:
            ...
            optimizer.zero_grad()
            outputs = model(proprio_input, noisy_heights)
        ...
        with torch.no_grad():
            for inputs, targets in test_loader:
                ...
                outputs = model(proprio_input, heightmap_input)
    ...
    with torch.no_grad():
        ...
        preds = model(proprio_input, heightmap_input)
...
if __name__ == '__main__':
    ...
    save_path = "unified_policy_nolabel"
