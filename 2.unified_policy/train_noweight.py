# python3 scripts/UMBC/2.unified_policy/train_noweight.py
...
def retrain_and_log(params, terrain_dirs, save_path):
    ...
    for epoch in range(params['epoch']):
        ...
        for inputs, targets in train_loader:
            ...
            # Standard loss calculation without adaptive weighting
...
if __name__ == '__main__':
    ...
    save_path = "unified_policy_no_adaptive_weighting"
