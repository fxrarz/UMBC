# python3 scripts/UMBC/2.unified_policy/train_one_hot.py
...
class LocomotionPolicy(nn.Module):
    def __init__(self, proprio_dim=69, heightmap_dim=187, output_dim=19, num_terrains=2):
        ...
        # The input size now adds num_terrains (the size of the 1-hot vector) instead of embed_dim
    ...
    def forward(self, proprio, heightmap, terrain_label):
        ...
        # Create 1-hot encoding and cast to float to concatenate with the other tensors
...
def retrain_and_log(params, terrain_dirs, save_path):
    ...
    model = LocomotionPolicy(num_terrains=num_terrains).to(device)
...
if __name__ == '__main__':
    ...
    save_path = "unified_policy_one_hot"
