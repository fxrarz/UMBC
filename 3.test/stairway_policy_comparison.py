#python3 scripts/UMBC/3.test/stairway_policy_comparison.py --policy_type no_adaptive_weight
...
def main():
    ...
    output_filename = f"scripts/UMBC/logs/metrics/stairway_{args_cli.policy_type}_policy.pkl"
    os.makedirs(os.path.dirname(output_filename), exist_ok=True)
    with open(output_filename, "wb") as f:
        pickle.dump(results, f)
        
    print('===============')
    print(f'Multi-Modal Stairway Terrain - Policy: {args_cli.policy_type}')
    print('===============')
