...
def main():
    ...
    if args_cli.push_force == 0:
        with open("scripts/UMBC/logs/metrics/unified_stairway_noperturbation.pkl", "wb") as f:
            pickle.dump(results, f)
    else:
        with open("scripts/UMBC/logs/metrics/unified_stairway_perturbation.pkl", "wb") as f:
            pickle.dump(results, f)


    print('===============')
    print('Multi-Modal Stairway Terrain under perturbation')
    print('===============')
