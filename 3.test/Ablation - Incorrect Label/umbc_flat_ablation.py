# correct label
#python3 scripts/UMBC/3.test/umbc_flat_ablation.py
# incorrect label
#python3 scripts/UMBC/3.test/umbc_flat_ablation.py --terrain_id 1
...
def main():
    ...
    if args_cli.terrain_id is not None:
        with open("scripts/UMBC/logs/metrics/test_ablation_flat_wrong_label.pkl", "wb") as f:
            pickle.dump(results, f)
    else:
        with open("scripts/UMBC/logs/metrics/test_ablation_flat_correct_label.pkl", "wb") as f:
            pickle.dump(results, f)

    print('===============')
    print(f'UMBC on flat terrain (Terrain ID: {terrain_id})')
    print('===============')
