# perturbation
#python3 scripts/UMBC/3.test/expert_flat_perturbation.py --push_force 50 --push_interval 10 --push_duration 10
# no perturbation
#python3 scripts/UMBC/3.test/expert_flat_perturbation.py --push_force 0 --push_interval 10 --push_duration 10
...
def main():
    ...
    if args_cli.push_force == 0:
        with open("scripts/UMBC/logs/metrics/test_expert_flat_noperturbation.pkl", "wb") as f:
            pickle.dump(results, f)
    else:
        with open("scripts/UMBC/logs/metrics/test_expert_flat_perturbation.pkl", "wb") as f:
            pickle.dump(results, f)

    print('===============')
    print('Expert on flat terrain w/o perturbation')
    print('===============')
