# correct label
# python3 scripts/UMBC/3.test/unified_stairway_ablation.py
# incorrect label
# python3 scripts/UMBC/3.test/unified_stairway_ablation.py --terrain_id 0
...
def main():
    ...
    if args_cli.terrain_id is not None:
        with open("scripts/UMBC/logs/metrics/unified_stairway_ablation_wrong_label.pkl", "wb") as f:
            pickle.dump(results, f)
    else:
        with open("scripts/UMBC/logs/metrics/unified_stairway_ablation.pkl", "wb") as f:
            pickle.dump(results, f)

    print('===============')
    print(f'Unified on stairway terrain (Terrain ID: {terrain_id})')
    print('===============')
