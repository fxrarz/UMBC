# python3 scripts/UMBC/3.test/expert_flat.py
...
class H1FlatDemo:
    def __init__(self):
        ...
        checkpoint = "scripts/UMBC/logs/models/drl_flat.pt"
...
def main():
    ...
    with open("scripts/UMBC/logs/metrics/expert_flat.pkl", "wb") as f:  # "wb" = write binary
        pickle.dump(results, f)
    print('===============')
    print('Expert - Flat Terrain')
    print('===============')
