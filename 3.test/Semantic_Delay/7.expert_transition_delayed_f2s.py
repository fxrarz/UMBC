# python3 scripts/behavior_cloning/test/multi_modal/unified_stairway.py
...
#                print("root height right after reset:", demo_h1.env.unwrapped.scene["robot"].data.root_pos_w[:, 2].item())
    ...
    with open(f"scripts/UMBC/logs/metrics/expert_transition_delay_f2s_ascend_{delay}.pkl", "wb") as f:
        pickle.dump(results, f)

    print('===============')
    print(f'UMBC Delayed Flat2Stair Ascend - {delay} timestep delay')
    print('===============')
